...
const Footer = () => {
  return (
    <div className="w-full h-screen bg-[#CDEA68] z-[999] py-10 flex gap-5 font-[Founders Grotesk]">
      <div className="w-1/2 h-full flex flex-col justify-between ">
        <div className="heading">
          <h1 className="text-[6vw] font-bold uppercase leading-none -mb-5 ">
            Eye-
          </h1>
          <h1 className="text-[6vw] font-bold uppercase leading-none -mb-5">
            Opening
          </h1>
          <p className="mt-20 text-2xl mr-15">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. At fuga nam itaque, quod minus aspernatur aut et ullam tempore harum. Lorem ipsum dolor sit amet consectetur adipisicing elit. Vitae vero exercitationem doloribus adipisci quidem harum laborum, architecto voluptas itaque fugiat.
          </p>
        </div>
        <svg
          width="72"
      ...
      <div className="w-1/2">
        <h1 className="text-[5vw] font-bold uppercase leading-none -mb-5 ">
          Presentations
        </h1>
        <div className="gets font-[Neue Montreal] mt-10">
