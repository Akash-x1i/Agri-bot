...
const Navbar = () => {
  ...
  return (
    ...
    >
          ...
          return (
            <Link
              ...
              className={`group relative text-lg font-semibold capitalize cursor-pointer px-3 py-1 rounded-md
                ...
                hover:bg-black/10`}
            >
              <span className="inline-block transition-transform duration-500 group-hover:animate-rollIn">
                {item}
              </span>
            </Link>
          );
      ...
      {/* Custom animations & underline styles */}
      <style jsx>{`
        /* underline logic */
        .hover-underline {
          position: relative;
